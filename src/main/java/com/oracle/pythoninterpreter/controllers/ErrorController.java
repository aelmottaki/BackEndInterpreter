...
public class ErrorController {
	...
	public final ResponseEntity<ErrorDetails> handleNoInterpreterFoundException(NoInterpreterFoundException ex, WebRequest request) {
		ErrorDetails errorDetails = new ErrorDetails(new Date(), NO_INTERPRETER_FOUND_EXCEPTION,
				request.getDescription(false));
		return new ResponseEntity<>(errorDetails, HttpStatus.BAD_REQUEST);
	}
}
